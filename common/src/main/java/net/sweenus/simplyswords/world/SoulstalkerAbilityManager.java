...
public final class SoulstalkerAbilityManager {
    ...
    public static boolean activate(WeaponAbilityContext context) {
        ...
        stride.setStepHeight((float) MathHelper.clamp(Config.uniqueEffects.soulstalker.stepHeight, 0.5, 4.0));
    ...
    public static void tickHeldPassive(LivingEntity owner, ItemStack stack) {
        ...
        int chance = MathHelper.clamp(Config.uniqueEffects.soulstalker.passiveChance, 0, 100);
