...
public final class DevourerAbilityManager {
    ...
    private static boolean acquireLooseTarget(ServerWorld world, ActiveMass mass,
        ...
        int tendrilCap = MathHelper.clamp(Config.uniqueEffects.devourer.looseTendrilCap, 1, 3);
    ...
    private static boolean corruptWeapon(ServerWorld world, Entity target, Vec3d center) {
        ...
        if (source.isOf(ItemsRegistry.WRAITHFANG.get())) {
            ...
            corrupted = ItemsRegistry.DREADWHISPER.get();
    ...
    private static void releaseLooseTarget(ServerWorld world, CapturedLoot captured,
        ...
        if (target != null) {
            ...
            target.removeScoreboardTag(CAPTURED_GRAVITY_TAG);
        }
    ...
    private static void purgeOrphans(ServerWorld world) {
        ...
        for (Entity entity : world.iterateEntities()) {
            if ((entity instanceof ItemEntity || entity instanceof ExperienceOrbEntity)
                ...
                entity.removeScoreboardTag(CAPTURED_GRAVITY_TAG);
