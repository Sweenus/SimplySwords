...
public final class WraithmawAbilityManager {
    ...
    public static boolean activate(WeaponAbilityContext context) {
        ...
        int count = MathHelper.clamp(Config.uniqueEffects.wraithmaw.cutlassCount, 1, 32);
        ...
        for (int index = 0; index < count; index++) {
            ...
            double distance = index == 0 ? 0.0 : radius * fraction * (0.82 + actor.getRandom().nextDouble() * 0.18);
    ...
    public static boolean tryRecover(ServerWorld world, LivingEntity owner,
        ...
        int maximum = MathHelper.clamp(Config.uniqueEffects.wraithmaw.maxRecovered, 1, 8);
