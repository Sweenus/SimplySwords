...
public final class Phase4LichbladeManager {
    ...
    private static int channelCooldown(ChannelState state, Phase4AbilityTuning tuning) {
    ...
    private static int auraInterval(Phase4AbilityTuning tuning) {
    ...
    private static void pulse(ServerWorld world, LivingEntity owner, ChannelState state,
                              Phase4AbilityTuning tuning, LivingEntity primary, boolean siphon) {
    ...
    private static double retargetPenalty(ChannelState state, Phase4AbilityTuning tuning) {
    ...
    private static void applyOverflowResistance(LivingEntity owner, ChannelState state,
                                                Phase4AbilityTuning tuning, float cap, float granted) {
    ...
    private static void grantTemporaryAbsorption(LivingEntity owner, float amount, int ticks) {
        Phase4AbsorptionTracker.grant(owner, Math.min(amount,
    ...
    private static void applyChannelMovementPenalty(LivingEntity owner, Phase4AbilityTuning tuning) {
