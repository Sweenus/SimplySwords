...
public class LivyatanSwordItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip1").formatted(Formatting.GOLD, Formatting.BOLD));
        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip2"));
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip3"));
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip4", shatter_timer_max /20, shatterDamage));
        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("item.simplyswords.onrightclick").formatted(Formatting.BOLD, Formatting.GREEN));
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip5"));
        tooltip.add(new TranslatableText("item.simplyswords.livyatansworditem.tooltip6"));
        tooltip.add(new LiteralText(""));
