...
public class VolcanicFurySwordItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip4"));
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip5"));
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip6"));
        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip7"));
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip8"));
        tooltip.add(new TranslatableText("item.simplyswords.volcanicfurysworditem.tooltip9"));
    }
