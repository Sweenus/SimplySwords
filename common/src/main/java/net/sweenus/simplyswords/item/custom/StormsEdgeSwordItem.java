...
public class StormsEdgeSwordItem extends SwordItem {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(new TranslatableText("item.simplyswords.stormsedgesworditem.tooltip1").formatted(Formatting.GOLD, Formatting.BOLD));
        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("item.simplyswords.stormsedgesworditem.tooltip2"));
        tooltip.add(new LiteralText(""));
        tooltip.add(new TranslatableText("item.simplyswords.onrightclick").formatted(Formatting.BOLD, Formatting.GREEN));
        tooltip.add(new TranslatableText("item.simplyswords.stormsedgesworditem.tooltip3"));
        tooltip.add(new TranslatableText("item.simplyswords.stormsedgesworditem.tooltip4"));
        tooltip.add(new TranslatableText("item.simplyswords.stormsedgesworditem.tooltip5"));
