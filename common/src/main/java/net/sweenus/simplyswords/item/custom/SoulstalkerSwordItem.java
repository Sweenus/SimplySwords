...
public final class SoulstalkerSwordItem extends UniqueSwordItem implements TwoHandedWeapon, UniqueWeaponActiveAbility {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        tooltip.add(Text.literal(""));
        appendAbilityCooldownTooltip(tooltip, stack, Config.uniqueEffects.soulstalker.cooldown);
    ...
    public static final class EffectSettings extends TooltipSettings {
        ...
        @ValidatedInt.Restrict(min = 1, max = 64) public int cleaveTargetCap = 32;
        @ValidatedInt.Restrict(min = 1, max = 64) public int leapImpactTargetCap = 32;
