...
public abstract class UniqueWeaponItem extends SwordItem {
    ...
    protected String itemRarity = "UNIQUE";

    protected UniqueWeaponItem(ToolMaterial toolMaterial, Settings settings) {
        super(toolMaterial, settings.fireproof());
    }

    @Override
    public int getMaxUseTime(ItemStack stack, LivingEntity user) {
        return getUniqueWeaponMaxUseTime(stack, user);
    }
    ...
    public boolean onClicked(ItemStack stack, ItemStack otherStack, Slot slot, ClickType clickType, PlayerEntity player,
        ...
        SimplySwordsAPI.onClickedGemSocketLogic(stack, otherStack, player, cursorStackReference);
        return false;
    }
    ...
    public Text getName(ItemStack stack) {
        ...
        return Text.translatable(this.getTranslationKey(stack)).setStyle(
                this.itemRarity.equals("UNIQUE") ? Styles.UNIQUE : Styles.COMMON);
    }
    ...
    public void appendTooltip(ItemStack itemStack, TooltipContext tooltipContext, List<Text> tooltip, TooltipType type) {
        appendUniqueWeaponTooltip(itemStack, tooltipContext, tooltip, type);
    }

    protected void appendUniqueWeaponTooltip(ItemStack itemStack, TooltipContext tooltipContext, List<Text> tooltip,
                                             TooltipType type) {
        appendSharedUniqueWeaponTooltip(itemStack, tooltipContext, tooltip, type);
    }

    protected final void appendSharedUniqueWeaponTooltip(ItemStack itemStack, TooltipContext tooltipContext,
    ...
    protected Identifier getConfigPath() {
        return Identifier.of(getConfigPathRoot() + "."
                + this.asItem().getRegistryEntry().registryKey().getValue().getPath());
    }

    protected void generateDynamicTooltip(ItemStack itemStack, TooltipContext tooltipContext, List<Text> tooltip,
                                          TooltipType type) {
