...
public final class SoulstalkerCleaveEntity extends Entity {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(DIRECTION, new Vector3f(0.0F, 0.0F, 1.0F));
        this.dataTracker.startTracking(INITIAL_WIDTH, 1.1F);
        this.dataTracker.startTracking(FINAL_WIDTH, 3.2F);
        this.dataTracker.startTracking(PROGRESS, 0.0F);
