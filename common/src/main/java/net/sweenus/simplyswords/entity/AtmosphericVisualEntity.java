...
public class AtmosphericVisualEntity extends Entity {
    ...
    protected void initDataTracker() {
        this.dataTracker.startTracking(ANCHOR_ID, -1);
        this.dataTracker.startTracking(KIND, STORM_VOLUME);
        this.dataTracker.startTracking(SHAPE, 0);
        this.dataTracker.startTracking(PRIMARY, 0x263E53);
        this.dataTracker.startTracking(SECONDARY, 0x8FE7FF);
        ...
        this.dataTracker.startTracking(DENSITY, 8);
        this.dataTracker.startTracking(PARAM_A, 0.0F);
        this.dataTracker.startTracking(PARAM_B, 0.0F);
        this.dataTracker.startTracking(INT_A, 1);
        this.dataTracker.startTracking(INT_B, 1);
        ...
        this.dataTracker.startTracking(ILLUMINATE, false);
    ...
    private void emitStormParticles() {
        ...
        if (this.age % 5 == 0) {
            ...
            this.getWorld().addParticle(ParticleTypes.CLOUD, x, y - 0.25, z,
