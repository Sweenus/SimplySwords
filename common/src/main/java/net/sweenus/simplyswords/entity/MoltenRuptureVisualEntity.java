...
public class MoltenRuptureVisualEntity extends Entity {

    private static final TrackedData<Float> TARGET_HEIGHT = DataTracker.registerData(MoltenRuptureVisualEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> HEIGHT_SCALE = DataTracker.registerData(MoltenRuptureVisualEntity.class, TrackedDataHandlerRegistry.FLOAT);

    public MoltenRuptureVisualEntity(EntityType<? extends MoltenRuptureVisualEntity> type, World world) {
        super(type, world);
        this.noClip = true;
        this.setNoGravity(true);
    }

    public MoltenRuptureVisualEntity(World world, double x, double y, double z, float targetHeight) {
        this(EntityRegistry.MOLTEN_RUPTURE_VISUAL.get(), world);
