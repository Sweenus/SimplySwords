...
public class LightningPhenomenonVisualEntity extends Entity {
    ...
    protected void initDataTracker(DataTracker.Builder builder) {
        builder.add(START_ID, -1); builder.add(END_ID, -1);
        builder.add(START_OFFSET, 0.0F); builder.add(END_OFFSET, 0.0F);
        builder.add(START_X, 0.0F); builder.add(START_Y, 0.0F); builder.add(START_Z, 0.0F);
        builder.add(END_X, 0.0F); builder.add(END_Y, 0.0F); builder.add(END_Z, 0.0F);
        builder.add(SHAPE, LightningPhenomenonShape.DIRECT_FLASH.ordinal());
        builder.add(PRIMARY, 0x2F8CFF); builder.add(CORE, 0xF7FDFF);
        builder.add(LIFETIME, 10); builder.add(DELAY, 0); builder.add(LEADER, 0);
        builder.add(WIDTH, 0.025F); builder.add(BRANCHES, 3); builder.add(SPREAD, 0.2F);
        builder.add(SEED, 0);
    }
