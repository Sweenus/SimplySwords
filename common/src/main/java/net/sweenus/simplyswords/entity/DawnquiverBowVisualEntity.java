...
public class DawnquiverBowVisualEntity extends Entity {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(HAND, 0);
        this.dataTracker.startTracking(MODE, MODE_ACTIVE);
        ...
        this.dataTracker.startTracking(DRAW_PROGRESS, 0.0F);
        this.dataTracker.startTracking(PHASE, PHASE_DRAWING);
        this.dataTracker.startTracking(RELEASE_AGE, 0);
    }
