...
public final class SoulstalkerStrideEntity extends MobEntity implements JumpingMount {
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(SURFACE_MODE, SURFACE_GROUND);
        this.dataTracker.startTracking(SURFACE_NORMAL, new Vector3f(0.0F, 1.0F, 0.0F));
        this.dataTracker.startTracking(SURFACE_FRAME_YAW, 0.0F);
        this.dataTracker.startTracking(STEP_SEQUENCE, 0);
    ...
    public double getMountedHeightOffset() {
        return MathHelper.clamp(Config.uniqueEffects.soulstalker.riderHeight, 0.5, 4.0);
    }
    ...
    private void resolveLeapImpact(ServerWorld world, LivingEntity owner, Vec3d impact,
        ...
        if (createStain) {
            GloamStainManager.createPatch(world, owner.getUuid(), impact,
                    ...
                    MathHelper.clamp(Config.uniqueEffects.soulstalker.stainSlowAmplifier, 0, 4));
        }
        ...
        world.playSound(null, center.x, center.y, center.z, SoundEvents.BLOCK_WET_GRASS_STEP,
    ...
    public int getStepLeg() {
        return MathHelper.clamp(dataTracker.get(STEP_LEG), 0, 5);
    }
