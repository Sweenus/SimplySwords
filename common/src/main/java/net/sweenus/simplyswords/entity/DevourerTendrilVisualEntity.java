...
public final class DevourerTendrilVisualEntity extends Entity {
    ...
    protected void initDataTracker() {
        this.dataTracker.startTracking(MASS_ID, -1);
        this.dataTracker.startTracking(TARGET_ID, -1);
        this.dataTracker.startTracking(LIFETIME, 120);
        this.dataTracker.startTracking(SEED, 0);
        this.dataTracker.startTracking(PULSE_AGE, -1000);
        this.dataTracker.startTracking(RETRACT_AGE, -1);
