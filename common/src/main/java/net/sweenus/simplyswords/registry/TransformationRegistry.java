...
public class TransformationRegistry {
    ...
    public static void register() {
        ...
        SimplySwordsAPI.registerTransformation(Blocks.NETHER_WART_BLOCK, new Identifier("simplyswords", "bloodwake"));
        SimplySwordsAPI.registerTransformation(Blocks.HAY_BLOCK, new Identifier("simplyswords", "riftmane"));
        SimplySwordsAPI.registerTransformation(Blocks.TARGET, new Identifier("simplyswords", "dawnquiver"));
    }
