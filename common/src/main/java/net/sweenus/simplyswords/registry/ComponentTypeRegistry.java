...
public class ComponentTypeRegistry {
    ...
    public static final RegistrySupplier<ComponentType<CombatProvenance>> COMBAT_PROVENANCE =
            COMPONENT_TYPES.register("combat_provenance", () -> ComponentType.<CombatProvenance>builder()
                    .codec(CombatProvenance.CODEC).build());
    ...
    public static final RegistrySupplier<ComponentType<Integer>> SOUL_DEBT_CAPACITY = COMPONENT_TYPES.register("soul_debt_capacity", () -> ComponentType.<Integer>builder().codec(Codec.INT).packetCodec(PacketCodecs.INTEGER).build());
    public static final RegistrySupplier<ComponentType<Integer>> DAWN_CHORUS_CAPACITY = COMPONENT_TYPES.register("dawn_chorus_capacity", () -> ComponentType.<Integer>builder().codec(Codec.INT).packetCodec(PacketCodecs.INTEGER).build());
    public static final RegistrySupplier<ComponentType<Float>> DAWN_MINIMUM_DRAW = COMPONENT_TYPES.register("dawn_minimum_draw", () -> ComponentType.<Float>builder().codec(Codec.FLOAT).packetCodec(PacketCodecs.FLOAT).build());
    ...
    public static final RegistrySupplier<ComponentType<Boolean>> MOLTEN_OVERCLOCKED = COMPONENT_TYPES.register("molten_overclocked", () -> ComponentType.<Boolean>builder().codec(Codec.BOOL).packetCodec(PacketCodecs.BOOL).build());
    public static final RegistrySupplier<ComponentType<IonCubeComponent>> ION_CUBES = COMPONENT_TYPES.register("ion_cubes", () -> ComponentType.<IonCubeComponent>builder().codec(IonCubeComponent.CODEC).packetCodec(IonCubeComponent.PACKET_CODEC).build());
