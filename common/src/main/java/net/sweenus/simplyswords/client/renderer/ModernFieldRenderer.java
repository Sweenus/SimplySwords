...
public final class ModernFieldRenderer {
    ...
    public static void renderParchmentTargetLine(MatrixStack matrices, VertexConsumerProvider vertexConsumers,
                                                  int age, Vec3d targetOffset) {
        renderTargetLine(matrices, vertexConsumers, age, targetOffset,
                242, 216, 154, 255, 236, 176);
    }

    public static void renderParchmentTargetRing(MatrixStack matrices, VertexConsumerProvider vertexConsumers,
                                                  int age, Vec3d targetOffset, float targetWidth) {
        renderTargetRing(matrices, vertexConsumers, age, targetOffset, targetWidth,
                242, 216, 154, 255, 236, 176);
    }
