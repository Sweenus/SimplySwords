...
public class SlowPower extends RunefusedGemPower {
	...
	public void appendTooltip(ItemStack itemStack, Item.TooltipContext tooltipContext, List<Text> tooltip, TooltipType type, boolean isRunic) {
		...
		if (Screen.hasAltDown()) {
			tooltip.add(Text.literal("\u00A0\u00A0\u00A0").append(Text.translatable("item.simplyswords.slownesssworditem.tooltip2")).setStyle(Styles.RUNIC_DESCRIPTION));
			tooltip.add(Text.literal("\u00A0\u00A0\u00A0").append(Text.translatable("item.simplyswords.slownesssworditem.tooltip3")).setStyle(Styles.RUNIC_DESCRIPTION));
		}
	}
