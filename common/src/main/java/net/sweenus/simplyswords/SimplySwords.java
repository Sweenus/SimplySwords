...
public class SimplySwords {
    ...
    public static void init() {
        ...
        LifecycleEvent.SERVER_LEVEL_UNLOAD.register(world -> {
            ...
            Phase4LichbladeManager.clear(world);
            Phase4StandardManager.clear(world);
            Phase4PassiveManager.clear(world);
            ...
            Phase7CombatManager.clear(world);
            Phase8CombatManager.clear(world);
            ...
            Phase9CombatManager.clear(world);
            Phase10WeaponManager.clear(world);
        });
        LifecycleEvent.SERVER_STOPPED.register(server -> {
            ...
            Phase4LichbladeManager.clearAll();
            Phase4StandardManager.clearAll();
            Phase4PassiveManager.clearAll();
            ...
            Phase7CombatManager.clearAll();
            Phase8CombatManager.clearAll();
            ...
            Phase9CombatManager.clearAll();
            Phase10WeaponManager.clearAll();
        });
        PlayerEvent.PLAYER_QUIT.register(player -> {
            ...
            Phase8CombatManager.clearActor(player);
            ...
            Phase10WeaponManager.clearActorState(player);
        });
