...
import net.sweenus.simplyswords.world.DevourerStainManager;
...
public class SimplySwords {
    ...
    public static void init() {
        ...
        LifecycleEvent.SERVER_LEVEL_UNLOAD.register(world -> {
            ...
            SoulrenderAbilityManager.clear(world);
            SoulrenderMarkVisualManager.clear(world);
            LichbladeMasteryManager.clear(world);
            BattleStandardMasteryManager.clear(world);
            LongPathFinalFormsMasteryCombatManager.clear(world);
            SoulstalkerAbilityManager.clear(world);
            WhisperwindVisualManager.clear(world);
            WhisperwindRhythmManager.clear(world);
            DreadwhisperAbilityManager.clear(world);
            DreadwhisperTrailManager.clear(world);
            HearthflameAbilityManager.clear(world);
            EmberbladeAbilityManager.clearAll(world);
            EmberlashAbilityManager.clear(world);
            FlamewindMasteryManager.clear(world);
            ...
            LivyatanWaveManager.clear(world);
            BramblethornAbilityManager.clear(world);
            WaxweaverEncasementManager.clear(world);
            NatureSwarmMasteryCombatManager.clear(world);
            DeathShadowBloodMasteryCombatManager.clear(world);
            RiftmaneAbilityManager.clear(world);
            DawnquiverAbilityManager.clear(world);
            ArcanethystAssaultManager.clear(world);
            StarsEdgeAbilityManager.clear(world);
            MagiscytheMasteryManager.clear(world);
            MagibladeAbilityManager.clear(world);
            MagispearAbilityManager.clear(world);
            ArcaneCosmicMasteryCombatManager.clear(world);
            RibboncleaverDreadtideMasteryManager.clear(world);
        });
        LifecycleEvent.SERVER_STOPPED.register(server -> {
            ...
            DevourerAbilityManager.clearAll();
            DevourerReprisalManager.clearAll();
            DevourerStainManager.clearAll();
            ...
            SoulrenderAbilityManager.clearAll();
            SoulrenderMarkVisualManager.clearAll();
            LichbladeMasteryManager.clearAll();
            BattleStandardMasteryManager.clearAll();
            LongPathFinalFormsMasteryCombatManager.clearAll();
            SoulstalkerAbilityManager.clearAll();
            WhisperwindVisualManager.clearAll();
            WhisperwindRhythmManager.clearAll();
            DreadwhisperAbilityManager.clearAll();
            DreadwhisperTrailManager.clearAll();
            ...
            FlamewindMasteryManager.clearAll();
            ...
            LivyatanWaveManager.clearAll();
            BramblethornAbilityManager.clearAll();
            WaxweaverEncasementManager.clearAll();
            NatureSwarmMasteryCombatManager.clearAll();
            DeathShadowBloodMasteryCombatManager.clearAll();
            RiftmaneAbilityManager.clearAll();
            DawnquiverAbilityManager.clearAll();
            ArcanethystAssaultManager.clearAll();
            StarsEdgeAbilityManager.clearAll();
            MagiscytheMasteryManager.clearAll();
            MagibladeAbilityManager.clearAll();
            MagispearAbilityManager.clearAll();
        ...
        PlayerEvent.PLAYER_QUIT.register(player -> {
            ...
            LivyatanWaveManager.clearActor(player);
            BramblethornAbilityManager.clearActor(player);
            WaxweaverEncasementManager.clearActor(player);
            NatureSwarmMasteryCombatManager.clearActor(player);
            DeathShadowBloodMasteryCombatManager.clearActor(player);
            RiftmaneAbilityManager.clearActor(player);
            DawnquiverAbilityManager.clearActor(player);
            ArcanethystAssaultManager.clearActor(player);
            StarsEdgeAbilityManager.clearActor(player);
            MagiscytheMasteryManager.clearActor(player);
            MagibladeAbilityManager.clearActor(player);
            MagispearAbilityManager.clearActor(player);
            RibboncleaverDreadtideMasteryManager.clearActorState(player);
        });
