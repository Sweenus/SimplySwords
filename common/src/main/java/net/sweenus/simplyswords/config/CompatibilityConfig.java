...
public class CompatibilityConfig extends ResettingConfig {
    ...
    public CompatibilityConfig() {
        super(new Identifier(SimplySwords.MOD_ID, "compatibility"));
    }
        ...
        public ValidatedIdentifierMap<Double> weaponSpellPowerBonuses =
                new ValidatedIdentifierMap.Builder<Double>()
                        .keyHandler(ValidatedIdentifier.ofRegistry(
                                new Identifier(SimplySwords.MOD_ID, "emberblade"), Registries.ITEM))
    ...
    private static ValidatedIdentifierMap<Identifier> schoolMap(
        ...
        Identifier defaultComponent = SpellScalingComponents.componentIds(kind).get(0);
        Identifier defaultSchool = spellPower
                ? new Identifier("spell_power", "arcane")
                : new Identifier("irons_spellbooks", "ender");
