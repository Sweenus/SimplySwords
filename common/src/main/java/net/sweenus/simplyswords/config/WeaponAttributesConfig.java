...
public class WeaponAttributesConfig implements ConfigData {
    ...
    public float claymore_positiveDamageModifier = 0.0f;
    public float greataxe_positiveDamageModifier = 0.0f;
    public float greathammer_positiveDamageModifier = 0.0f;
    public float chakram_positiveDamageModifier = 0.0f;
    public float scythe_positiveDamageModifier = 0.0f;
    public float halberd_positiveDamageModifier = 0.0f;

    @ConfigEntry.Gui.PrefixText
    public float longsword_negativeDamageModifier = 0.0f;
    public float twinblade_negativeDamageModifier = 0.0f;
    public float rapier_negativeDamageModifier = 0.0f;
    public float katana_negativeDamageModifier = 0.0f;
    public float sai_negativeDamageModifier = 0.0f;
    ...
    public float chakram_negativeDamageModifier = 0.0f;
    public float scythe_negativeDamageModifier = 0.0f;
    public float halberd_negativeDamageModifier = 0.0f;

    @ConfigEntry.Gui.PrefixText
    public float iron_damageModifier = 0.0f;
    public float gold_damageModifier = 0.0f;
    public float diamond_damageModifier = 0.0f;
    public float netherite_damageModifier = 0.0f;
    public float runic_damageModifier = 0.0f;
    public float adamantite_damageModifier = 0.0f;
    public float aquarium_damageModifier = 0.0f;
    public float banglum_damageModifier = 0.0f;
    public float carmot_damageModifier = 0.0f;
    public float kyber_damageModifier = 0.0f;
    public float mythril_damageModifier = 0.0f;
    public float orichalcum_damageModifier = 0.0f;
    public float durasteel_damageModifier = 0.0f;
    public float osmium_damageModifier = 0.0f;
    public float prometheum_damageModifier = 0.0f;
    public float quadrillum_damageModifier = 0.0f;
    public float runite_damageModifier = 0.0f;
    public float starPlatinum_damageModifier = 0.0f;
    public float bronze_damageModifier = 0.0f;
    public float copper_damageModifier = 0.0f;
    public float steel_damageModifier = 0.0f;
    public float palladium_damageModifier = 0.0f;
    public float stormyx_damageModifier = 0.0f;
    public float celestium_damageModifier = 0.0f;
    public float metallurgium_damageModifier = 0.0f;
    public float gobber_damageModifier = 0.0f;
    public float gobberNether_damageModifier = 0.0f;
    public float gobberEnd_damageModifier = 0.0f;
