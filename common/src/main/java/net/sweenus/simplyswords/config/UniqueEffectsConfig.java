...
public class UniqueEffectsConfig extends Config {
    ...
    public ValidatedIdentifierMap<Integer> weaponManaCosts = new ValidatedIdentifierMap.Builder<Integer>()
            .keyHandler(ValidatedIdentifier.ofRegistry(new Identifier(SimplySwords.MOD_ID, "emberblade"), Registries.ITEM))
            .valueHandler(new ValidatedInt(0, 10000, 0))
            .defaults(
                    ImmutableMap.<Identifier, Integer>builder()
                            .put(new Identifier(SimplySwords.MOD_ID, "arcanethyst"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "awakened_lichblade"), 55)
                            .put(new Identifier(SimplySwords.MOD_ID, "bloodwake"), 15)
                            .put(new Identifier(SimplySwords.MOD_ID, "bramblethorn"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "brimstone_claymore"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "caelestis"), 150)
                            .put(new Identifier(SimplySwords.MOD_ID, "chompolotl"), 43)
                            .put(new Identifier(SimplySwords.MOD_ID, "dawnquiver"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "dreadtide"), 0)
                            .put(new Identifier(SimplySwords.MOD_ID, "dreadwhisper"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "emberblade"), 15)
                            .put(new Identifier(SimplySwords.MOD_ID, "emberlash"), 20)
                            .put(new Identifier(SimplySwords.MOD_ID, "enigma"), 100)
                            .put(new Identifier(SimplySwords.MOD_ID, "flamewind"), 30)
                            .put(new Identifier(SimplySwords.MOD_ID, "frostfall"), 17)
                            .put(new Identifier(SimplySwords.MOD_ID, "gloampiercer"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "harbinger"), 67)
                            .put(new Identifier(SimplySwords.MOD_ID, "hearthflame"), 25)
                            .put(new Identifier(SimplySwords.MOD_ID, "hiveheart"), 80)
                            .put(new Identifier(SimplySwords.MOD_ID, "icewhisper"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "ionbound_stormscale"), 25)
                            .put(new Identifier(SimplySwords.MOD_ID, "livyatan"), 10)
                            .put(new Identifier(SimplySwords.MOD_ID, "magiblade"), 15)
                            .put(new Identifier(SimplySwords.MOD_ID, "magiscythe"), 77)
                            .put(new Identifier(SimplySwords.MOD_ID, "magispear"), 35)
                            .put(new Identifier(SimplySwords.MOD_ID, "mjolnir"), 55)
                            .put(new Identifier(SimplySwords.MOD_ID, "molten_edge"), 10)
                            .put(new Identifier(SimplySwords.MOD_ID, "ribboncleaver"), 10)
                            .put(new Identifier(SimplySwords.MOD_ID, "riftmane"), 60)
                            .put(new Identifier(SimplySwords.MOD_ID, "shadowsting"), 70)
                            .put(new Identifier(SimplySwords.MOD_ID, "soulkeeper"), 40)
                            .put(new Identifier(SimplySwords.MOD_ID, "soulpyre"), 115)
                            .put(new Identifier(SimplySwords.MOD_ID, "soulrender"), 10)
                            .put(new Identifier(SimplySwords.MOD_ID, "soulstalker"), 100)
                            .put(new Identifier(SimplySwords.MOD_ID, "soulstealer"), 60)
                            .put(new Identifier(SimplySwords.MOD_ID, "stars_edge"), 52)
                            .put(new Identifier(SimplySwords.MOD_ID, "stormbringer"), 10)
                            .put(new Identifier(SimplySwords.MOD_ID, "storms_edge"), 30)
                            .put(new Identifier(SimplySwords.MOD_ID, "stormscale"), 25)
                            .put(new Identifier(SimplySwords.MOD_ID, "sunfire"), 67)
                            .put(new Identifier(SimplySwords.MOD_ID, "tempest"), 20)
                            .put(new Identifier(SimplySwords.MOD_ID, "the_devourer"), 60)
                            .put(new Identifier(SimplySwords.MOD_ID, "thunderbrand"), 45)
                            .put(new Identifier(SimplySwords.MOD_ID, "toxic_longsword"), 0)
                            .put(new Identifier(SimplySwords.MOD_ID, "twisted_blade"), 20)
                            .put(new Identifier(SimplySwords.MOD_ID, "waxweaver"), 40)
                            .put(new Identifier(SimplySwords.MOD_ID, "whisperwind"), 40)
                            .put(new Identifier(SimplySwords.MOD_ID, "wickpiercer"), 3)
                            .put(new Identifier(SimplySwords.MOD_ID, "wraithfang"), 40)
                            .put(new Identifier(SimplySwords.MOD_ID, "wraithmaw"), 47)
                            .build()
            ).build();
