...
public class SimplySwordsAPI {
    ...
    /**
     * Resolves a base, wielder-owned weapon cooldown exactly once. All unique
     * weapon abilities opt into Iron's cooldown reduction unless they
     * explicitly override UniqueWeaponActiveAbility#usesSpellCooldownReduction(ItemStack).
     */
    ...
    /**
     * Commits a base weapon cooldown through the shared compatibility policy.
     * Passing zero clears the cooldown; negative values are ignored.
     */
