...
final class SpellScalingRegistry {
    ...
    private static void registerBuiltIn(SpellScalingProfile profile, String spellPowerSchool, String spellPowerLabel,
        ...
        register(new SpellScalingDefinition(
                profile.registryId(),
                new SpellScalingTarget(Identifier.of("spell_power", spellPowerSchool), displayKey(spellPowerLabel)),
                new SpellScalingTarget(Identifier.of("irons_spellbooks", ironsSchool), displayKey(ironsLabel))
        ));
    }
