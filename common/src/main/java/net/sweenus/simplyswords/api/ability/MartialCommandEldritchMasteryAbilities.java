...
public final class MartialCommandEldritchMasteryAbilities {
    public static final Identifier HIT = id("mastery/martial_command_eldritch/hit");
    public static final Identifier PULSE = id("mastery/martial_command_eldritch/pulse");
    public static final Identifier KILL = id("mastery/martial_command_eldritch/kill");
    public static final Identifier FINISH = id("mastery/martial_command_eldritch/finish");
    public static final UniqueAbilityKey<MartialCommandEldritchMasteryTuning> TUNING = UniqueAbilityKey.value(
            id("mastery/martial_command_eldritch/tuning"), MartialCommandEldritchMasteryTuning.class, MartialCommandEldritchMasteryTuning.EMPTY);
    public static final UniqueAbilityKey<Integer> COOLDOWN_TICKS = UniqueAbilityKey.integer(
            id("mastery/martial_command_eldritch/cooldown_ticks"), 0, 0, 72000);
    ...
    private MartialCommandEldritchMasteryAbilities() {
    }
    ...
    public static MartialCommandEldritchMasteryTuning tuning(UniqueAbilityExecution execution) {
        return execution == null ? MartialCommandEldritchMasteryTuning.EMPTY : execution.tuning().get(TUNING);
    }
