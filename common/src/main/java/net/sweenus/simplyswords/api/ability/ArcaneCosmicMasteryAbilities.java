...
public final class ArcaneCosmicMasteryAbilities {
    public static final Identifier HIT = id("mastery/arcane_cosmic/hit");
    public static final Identifier PULSE = id("mastery/arcane_cosmic/pulse");
    public static final Identifier KILL = id("mastery/arcane_cosmic/kill");
    public static final Identifier FINISH = id("mastery/arcane_cosmic/finish");
    public static final UniqueAbilityKey<ArcaneCosmicMasteryTuning> TUNING = UniqueAbilityKey.value(
            id("mastery/arcane_cosmic/tuning"), ArcaneCosmicMasteryTuning.class, ArcaneCosmicMasteryTuning.EMPTY);
    public static final UniqueAbilityKey<Integer> COOLDOWN_TICKS = UniqueAbilityKey.integer(
            id("mastery/arcane_cosmic/cooldown_ticks"), 0, 0, 72000);
    ...
    private ArcaneCosmicMasteryAbilities() {
    }
    ...
    public static ArcaneCosmicMasteryTuning tuning(UniqueAbilityExecution execution) {
        return execution == null ? ArcaneCosmicMasteryTuning.EMPTY : execution.tuning().get(TUNING);
    }
