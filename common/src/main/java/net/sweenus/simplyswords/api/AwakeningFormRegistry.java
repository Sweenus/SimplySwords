...
public final class AwakeningFormRegistry {
    ...
    public static final Identifier WICKPIERCER_ROUTE = new Identifier(SimplySwords.MOD_ID, "wickpiercer");
    public static final Identifier GLOAMPIERCER_ROUTE = new Identifier(SimplySwords.MOD_ID, "gloampiercer");
    public static final Identifier SOULRENDER_ROUTE = new Identifier(SimplySwords.MOD_ID, "soulrender");
    public static final Identifier SOULSTALKER_ROUTE = new Identifier(SimplySwords.MOD_ID, "soulstalker");
    public static final Identifier WHISPERWIND_ROUTE = new Identifier(SimplySwords.MOD_ID, "whisperwind");
    public static final Identifier DREADWHISPER_ROUTE = new Identifier(SimplySwords.MOD_ID, "dreadwhisper");
    ...
    public static synchronized void registerBuiltins() {
        ...
        register(AwakeningFormFamily.builder(
                        ...
                        AwakeningProfile.DEFAULT,
                        new Identifier(SimplySwords.MOD_ID, "wickpiercer"))
                ...
                .route(WICKPIERCER_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "spectral_wickpiercer"), 0,
                        ItemsRegistry.WICKPIERCER.get(), "item.simplyswords.wickpiercer",
                        AwakeningFormRarity.UNIQUE, 0.0F))
                .route(GLOAMPIERCER_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "gloampiercer"), 0,
        ...
        register(AwakeningFormFamily.builder(
                        ...
                        AwakeningProfile.DEFAULT,
                        new Identifier(SimplySwords.MOD_ID, "soulrender"))
                ...
                .route(SOULRENDER_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "spectral_soulrender"), 0,
                        ItemsRegistry.SOULRENDER.get(), "item.simplyswords.soulrender",
                        AwakeningFormRarity.UNIQUE, 0.0F))
                .route(SOULSTALKER_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "soulstalker"), 0,
        ...
        register(AwakeningFormFamily.builder(
                        ...
                        AwakeningProfile.DEFAULT,
                        new Identifier(SimplySwords.MOD_ID, "whisperwind"))
                ...
                .route(WHISPERWIND_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "spectral_whisperwind"), 0,
                        ItemsRegistry.WHISPERWIND.get(), "item.simplyswords.whisperwind",
                        AwakeningFormRarity.UNIQUE, 0.0F))
                .route(DREADWHISPER_ROUTE, new AwakeningFormStage(
                        new Identifier(SimplySwords.MOD_ID, "dreadwhisper"), 0,
