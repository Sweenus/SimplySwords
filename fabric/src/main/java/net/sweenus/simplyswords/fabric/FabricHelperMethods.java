...
public class FabricHelperMethods {
    ...
    public static float useSpellAttributeScaling(float damageModifier, LivingEntity player,
        ...
        if (Platform.isFabric()
                ...
                && player != null && !player.getWorld().isClient) {
