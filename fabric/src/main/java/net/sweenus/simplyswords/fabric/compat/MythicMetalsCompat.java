...
public class MythicMetalsCompat {
    ...
    static int adamantite_modifier = (int) SimplySwords.weaponAttributesConfig.adamantite_damageModifier;
    static int aquarium_modifier = (int) SimplySwords.weaponAttributesConfig.aquarium_damageModifier;
    static int banglum_modifier = (int) SimplySwords.weaponAttributesConfig.banglum_damageModifier;
    static int carmot_modifier = (int) SimplySwords.weaponAttributesConfig.carmot_damageModifier;
    static int kyber_modifier = (int) SimplySwords.weaponAttributesConfig.kyber_damageModifier;
    static int mythril_modifier = (int) SimplySwords.weaponAttributesConfig.mythril_damageModifier;
    static int orichalcum_modifier = (int) SimplySwords.weaponAttributesConfig.orichalcum_damageModifier;
    static int durasteel_modifier = (int) SimplySwords.weaponAttributesConfig.durasteel_damageModifier;
    static int osmium_modifier = (int) SimplySwords.weaponAttributesConfig.osmium_damageModifier;
    static int prometheum_modifier = (int) SimplySwords.weaponAttributesConfig.prometheum_damageModifier;
    static int quadrillum_modifier = (int) SimplySwords.weaponAttributesConfig.quadrillum_damageModifier;
    static int runite_modifier = (int) SimplySwords.weaponAttributesConfig.runite_damageModifier;
    static int star_platinum_modifier = (int) SimplySwords.weaponAttributesConfig.starPlatinum_damageModifier;
    static int bronze_modifier = (int) SimplySwords.weaponAttributesConfig.bronze_damageModifier;
    static int copper_modifier = (int) SimplySwords.weaponAttributesConfig.copper_damageModifier;
    static int steel_modifier = (int) SimplySwords.weaponAttributesConfig.steel_damageModifier;
    static int palladium_modifier = (int) SimplySwords.weaponAttributesConfig.palladium_damageModifier;
    static int stormyx_modifier = (int) SimplySwords.weaponAttributesConfig.stormyx_damageModifier;
    static int celestium_modifier = (int) SimplySwords.weaponAttributesConfig.celestium_damageModifier;
    static int metallurgium_modifier = (int) SimplySwords.weaponAttributesConfig.metallurgium_damageModifier;
