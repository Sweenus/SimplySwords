...
SimplySwordsClientAPI.registerParchmentGlyphStyle(
        new Identifier("exampleaddon", "rift_blue"),
        new ParchmentGlyphStyle(
                new Identifier("exampleaddon", "textures/entity/rift_glyphs.png"),
                new Identifier("exampleaddon", "textures/entity/rift_glyphs_glow.png"),
                8,
                8,
                0xFFB8E8FF,
                0xFF7CCEFF,
